...
export default function ProfilePage() {
    ...
    return (
        <div className="p-4 sm:p-6 lg:p-8 max-w-4xl mx-auto w-full text-zinc-100">
            ...
            <div className="relative overflow-hidden bg-gradient-to-br from-zinc-900 via-zinc-800 to-zinc-900 border border-zinc-700/60 rounded-3xl p-6 sm:p-8 shadow-2xl mb-6">
                ...
                {/* সফট ব্যাকগ্রাউন্ড গ্লো (চোখে আরামদায়ক করার জন্য অপাসিটি কমানো হয়েছে) */}
                ...
                <div className="flex flex-col sm:flex-row items-center gap-6 text-center sm:text-left relative z-10">
                    ...
                    <div className="relative group">
                        ...
                        {/* ইমেজ চেঞ্জ করার বাটন */}
                        <button className="absolute -bottom-1 -right-1 p-2 bg-emerald-500 hover:bg-emerald-400 text-zinc-950 rounded-xl shadow-lg transition-all active:scale-95">
                    ...
                    <div className="flex-1">
                        ...
                        <div className="mt-5 flex flex-wrap justify-center sm:justify-start gap-2">
                            <button className="btn btn-sm bg-zinc-800 hover:bg-zinc-700 text-zinc-200 border border-zinc-700 rounded-xl normal-case gap-2 text-xs font-semibold px-4 shadow-md transition-all">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                ...
                <div className="bg-zinc-900/90 backdrop-blur-md border border-zinc-800 rounded-2xl p-5 sm:p-6 shadow-xl">
                    ...
                    <div className="space-y-3">
                        <div className="flex items-center gap-4 bg-zinc-800/40 p-3.5 rounded-xl border border-zinc-800/80 hover:border-zinc-700 transition-colors">
