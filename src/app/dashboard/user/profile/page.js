...
export default function ProfilePage() {
        ...
        return (
            <div className="flex items-center justify-center min-h-[70vh]">
                <div className="flex flex-col items-center gap-4">
                    ...
                    <p className="text-sm text-zinc-500 animate-pulse font-medium">Loading your profile...</p>
                </div>
            </div>
        );
    }
    ...
    if (!session?.user) {
        return (
            <div className="flex items-center justify-center min-h-[70vh] px-4">
                <div className="text-center p-8 bg-zinc-900 border border-zinc-800 rounded-2xl max-w-sm w-full shadow-2xl backdrop-blur-sm">
                    ...
                    <p className="text-zinc-400 text-sm mb-6">Please log in to view your profile dashboard.</p>
                    <button className="w-full bg-emerald-600 hover:bg-emerald-500 text-white font-semibold py-2.5 px-4 rounded-xl transition duration-200 shadow-lg shadow-emerald-900/20 text-sm">
                        Go to Login
                    </button>
                </div>
            </div>
    ...
    return (
        <div className="p-4 sm:p-6 lg:p-8 max-w-4xl mx-auto w-full text-zinc-100 relative min-h-screen">
            ...
            <div className="relative overflow-hidden bg-gradient-to-br from-zinc-900 via-zinc-900/95 to-zinc-950 border border-zinc-800/80 rounded-3xl p-6 sm:p-8 shadow-2xl mb-6">
                    ...
                    <div className="flex-1 flex flex-col sm:flex-row sm:items-center justify-between gap-4 w-full">
                        <div>
                            <div className="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-3 justify-center sm:justify-start">
                                ...
                                <span className="capitalize px-3 py-0.5 text-xs font-semibold tracking-wide bg-emerald-500/10 text-emerald-400 border border-emerald-500/20 rounded-full w-fit mx-auto sm:mx-0">
                                    {role === 'vender' ? 'Vendor' : role || 'User'}
                                </span>
                            </div>
                            <p className="text-zinc-400 text-sm sm:text-base mt-1 font-medium">{email}</p>
                        </div>
                    </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                ...
                <div className="bg-zinc-900/60 backdrop-blur-md border border-zinc-800/80 rounded-2xl p-5 sm:p-6 shadow-xl">
                    <h3 className="text-xs font-bold text-zinc-400 uppercase tracking-widest mb-4 border-b border-zinc-800 pb-2">
                        Account Information
                    </h3>
                    <div className="space-y-3">
                        <div className="flex items-center gap-4 bg-zinc-800/30 p-3.5 rounded-xl border border-zinc-800/50">
                            ...
                            <div className="min-w-0 flex-1">
                                ...
                                <p className="text-sm font-medium text-zinc-200 mt-0.5 truncate">{name || "N/A"}</p>
                            </div>
                        </div>
                        ...
                        <div className="flex items-center gap-4 bg-zinc-800/30 p-3.5 rounded-xl border border-zinc-800/50">
                            ...
                            <div className="min-w-0 flex-1">
                                ...
                                <p className="text-sm font-medium text-zinc-200 mt-0.5 break-all truncate">{email}</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className="bg-zinc-900/60 backdrop-blur-md border border-zinc-800/80 rounded-2xl p-5 sm:p-6 shadow-xl">
                    ...
                    <div className="space-y-3">
                        <div className="flex items-center gap-4 bg-zinc-800/30 p-3.5 rounded-xl border border-zinc-800/50">
                            ...
                            <div className="min-w-0 flex-1">
                                <p className="text-[10px] text-zinc-500 font-bold uppercase tracking-wider">Account Role</p>
                                <p className="text-sm font-semibold text-emerald-400 mt-0.5 capitalize truncate">
